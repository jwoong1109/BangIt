...
public class SecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .csrf(csrf -> csrf
                .ignoringRequestMatchers("/generate-order-id")
            )
            // 요청에 대한 보안 설정
            .authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers("/", "/login", "/logout", "/partner-login", "/business-registration", "/bangItBot/**", "/success/**", "/fail/**", "/confirm/**", "/generate-order-id", "/get-nearby-hotels", "/search/**").permitAll()
                // 특정 역할에 따라 접근 권한 부여
